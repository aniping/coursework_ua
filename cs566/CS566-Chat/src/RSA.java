...
//		System.out.println(RSA.bigInteger2HexStr(encrypted_msg));
		return RSA.bigInteger2HexStr(encrypted_msg);
	}
	 ...
	 */
	public static String RSAdecrypt(StringBuilder cStr, StringBuilder nStr, StringBuilder dStr){
...
//		System.out.println(new String(decrypted_msg.toByteArray()));
		return new String(decrypted_msg.toByteArray());
	}
